            ...
            children: [
              Row(
                ...
                children: [
                  Text('Expense'),
                  Switch(
                    activeColor: Color.fromARGB(255, 0, 95, 112),
                    value:_seletincome,
                    onChanged: (Value) {
                      setState(() {
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  Map<String, dynamic> item = items1[index];
                  return ListTile(
                      title: Text(item['name'],style: TextStyle(color: Color.fromARGB(
                          255, 8, 245, 253)),),
                      subtitle: Text(DateFormat.Md().format(DateTime.now()),style: TextStyle(color: Color.fromARGB(
                          255, 8, 245, 253))),
                      trailing: Text(item['amount'].toString(),style: TextStyle(color: Color.fromARGB(
                          255, 8, 245, 253))),
                      leading: item['isIncome']
                          ? Icon(Icons.arrow_upward,color:Color.fromARGB(
                          255, 19, 255, 74),)
